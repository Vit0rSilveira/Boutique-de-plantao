  ...
  return (
    <form action="">
      <div id="dados-pessoais">
        ...
        <input type="text" name="nomeCompleto" id="nome-completo" value={formData.nomeCompleto} onChange={handleChange} />
        ...
        <input type="password" name="confirmacaoSenha" id="confirmacao-senha" placeholder="Confirme sua Senha" value={formData.confirmacaoSenha} onChange={handleChange} />
      </div>
